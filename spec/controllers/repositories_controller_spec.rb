  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved repository as @repository" do
        ...
        post :create, {:repository => { "authentication_id" => "invalid value" }}, valid_session
        assigns(:repository).should be_a_new(Repository)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested repository" do
        ...
        Repository.any_instance.should_receive(:update_attributes).with({ "authentication_id" => "1" })
        put :update, {:id => repository.to_param, :repository => { "authentication_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the repository as @repository" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Repository.any_instance.stub(:save).and_return(false)
        put :update, {:id => repository.to_param, :repository => { "authentication_id" => "invalid value" }}, valid_session
        assigns(:repository).should eq(repository)
      end
